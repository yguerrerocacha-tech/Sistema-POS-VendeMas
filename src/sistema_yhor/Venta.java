...
public class Venta extends JFrame {
    ...
    // 🚀 COMPONENTES PARA EL VISOR DEL TICKET AL LADO
    ...
    public Venta() {
        ...
        formPanel.setBounds(10, 110, 460, 560);
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (rs.next()) {
                        ...
                        JOptionPane.showMessageDialog(Venta.this, "⚠️ Producto no encontrado.");
        ...
        lblDni.setBounds(240, 230, 90, 25);
        formPanel.add(lblDni);

        txtDniVenta = new JTextField();
        txtDniVenta.setBounds(320, 230, 120, 30);
        ...
        lblNomCli.setBounds(20, 325, 90, 25);
        formPanel.add(lblNomCli);
        
        txtClienteNombre = new JTextField();
        txtClienteNombre.setBounds(110, 325, 275, 30);
        formPanel.add(txtClienteNombre);

        btnBuscarCliente = new JButton("🔍");
        btnBuscarCliente.setBounds(390, 325, 50, 30);
        ...
        btnBuscarCliente.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // 🚀 EL CANDADO INFERIOR: Validar que tenga exactamente 8 dígitos
                if (dni.length() != 8) {
                    JOptionPane.showMessageDialog(Venta.this, 
        ...
        btnCalcular.setBounds(20, 380, 420, 45);
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        if (stockActual >= cant) {
                            ...
                            // 🚀 ACTUALIZAMOS LA VISTA PREVIA LIVE CADA VEZ QUE AGREGA UN ITEM
                            actualizarVistaPreviaLive();
        ...
        // --- 🚀 CONSTRUCCIÓN DEL VISOR DE TICKET LATERAL (AL LADO) ---
        txtVisorTicket = new JTextArea();
        txtVisorTicket.setEditable(false);
        txtVisorTicket.setBackground(new Color(255, 255, 240)); // Color continuo marfil
        ...
        btnFinalizar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String queryVenta = "INSERT INTO venta (cliente, subtotal, descuento, total_pagado, fecha_hora) VALUES (?, ?, ?, ?, NOW())";
                    ...
                    // ==========================================================
                    // 🚀 DISPARO ULTRA VELOZ: Abre en el Bloc de Notas (.txt) al toque
                    // ==========================================================
                    BoletaVenta boleta = new BoletaVenta();
                 // Cambia "obtainTextoTicket" por "obtenerTextoTicket"
                    ...
                    txtVisorTicket.setText(""); // Limpia visor lateral
        ...
        // --- MOTOR ELÁSTICO RESPONSIVO REDISEÑADO CON VISOR LATERAL ---
        this.addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                // Distribución proporcional de espacio
                int anchoVisor = 320; // Ancho fijo para emular ticketera de 80mm
                ...
                // Ubicamos componentes de la caja central
                scrollCarrito.setBounds(490, 110, anchoScrollCarrito, altoScroll);
                lblTotalParcial.setBounds(490, 110 + altoScroll + 10, 400, 25);
                
                // Ubicamos el Visor lateral a la derecha exacta del carrito
                scrollVisorTicket.setBounds(490 + anchoScrollCarrito + 15, 110, anchoVisor, altoScroll + 35);
                
                int ejeYBotones = 110 + altoScroll + 50;
    ...
    // 🚀 MÉTODO LIVE: Genera el bosquejo del ticket al vuelo sin tocar la Base de Datos
